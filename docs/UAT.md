...
| UAT-04 | P1 | **Tetap fokus di aplikasi lain:** jalankan timer, masuk mini mode, pindah ke aplikasi lain, lalu kembali dengan klik dan `Esc`. | Widget selalu di atas; lingkaran progres, sisa waktu, dan mode terlihat seperti versi kecil dari timer utama. Timer tetap berjalan, dan ukuran/jendela sebelumnya dipulihkan tanpa mengejutkan pengguna. |
